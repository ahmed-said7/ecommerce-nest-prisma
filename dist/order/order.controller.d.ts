...
export declare class OrderController {
    ...
    orderCashCreate(user: UserInterface): Promise<{
        order: {
            id: number;
            price: number;
            userId: number;
    ...
    getSession(user: UserInterface, req: Request): Promise<{
        session: import("stripe").Stripe.Response<import("stripe").Stripe.Checkout.Session>;
    }>;
    delOrder(user: UserInterface, id: number): Promise<{
        status: string;
    }>;
    ...
    getAll(query: OrderQueryDto): Promise<{
        orders: ({} & {
            id: number;
            price: number;
            userId: number;
    ...
    updateDelivered(id: number): Promise<{
        order: {
            user: {
                id: number;
                name: string;
    ...
    stripePostReq(req: Request): Promise<void>;
}
