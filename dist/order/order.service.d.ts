...
export declare class OrderService {
    ...
    private prisma;
    constructor(api: ApiService<OrderQueryDto>, config: ConfigService, stripeService: StripeService, prisma: PrismaService);
    createCashOrder(user: UserInterface): Promise<{
        order: {
            id: number;
            price: number;
            userId: number;
            ...
            paid: boolean;
            tax: number;
            method: import(".prisma/client").$Enums.OrderType;
        };
    }>;
    ...
    deleteOrder(id: number, user: UserInterface): Promise<{
        status: string;
    }>;
    updateDeliveredOrder(id: number): Promise<{
        order: {
            user: {
                id: number;
                name: string;
    ...
    updatePaidOrder(id: number): Promise<{
        order: {
            user: {
                id: number;
                name: string;
    ...
    checkoutSession(user: UserInterface, req: Request): Promise<{
        session: import("stripe").Stripe.Response<import("stripe").Stripe.Checkout.Session>;
    }>;
    webhookSession(req: Request): Promise<void>;
    private createOnlineOrder;
    private updateProducts;
    getAllOrders(query: OrderQueryDto): Promise<{
        orders: ({} & {
            id: number;
            price: number;
            userId: number;
